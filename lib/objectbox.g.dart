...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    entities: _entities,
    lastEntityId: const obx_int.IdUid(6, 1719162806145288594),
    lastIndexId: const obx_int.IdUid(1, 3553733258145972750),
    lastRelationId: const obx_int.IdUid(2, 1145702904327087714),
    lastSequenceId: const obx_int.IdUid(0, 0),
    retiredEntityUids: const [6611800482854361317, 1719162806145288594],
    retiredIndexUids: const [7961270678120073529, 2363337148466994],
